      ...
      <div class="col-md-6 app_register_form">
        <form @submit.prevent="onResetPassword">
          <div class="row form-group">
            <div class="col-md-12">
              <p style="text-align: center"><b>Update Your Password</b></p>
            </div>
          </div>
          <div class="row form-group"
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <button type="submit" class="btn btn-success" :disabled="$v.user.$invalid">Update Password</button>
            </div>
          </div>
        </form>
      </div>
...
export default {
  ...
  watch: {
      resetChangePasswordForm: function(val){
          if (val){
              this.user.password = '';
              this.user.confirmPassword= '';
              this.$v.user.$reset();
              this.$store.commit('resetChangePasswordForm',false);
          } 
      }
  },
}
