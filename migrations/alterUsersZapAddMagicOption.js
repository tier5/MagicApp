/**
 * Name : alterUsersAddingIsActiveAndIsAdmin.js
 * Purpose : Alter Collection users , Adding a field magicOptions default false to all the zaps created , 
...
MongoClient.connect(url, function(err, client) {
    ...
    // add magicOption if not present
