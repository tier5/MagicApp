              ...
              <v-layout row wrap>
                <v-flex md12>
                    <div class="privacy ppTacPage">
                            ...
                            <p>Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the https://www.amagiczap.com website (the "Service") operated by Tier5 ("us", "we", or "our").</p>
